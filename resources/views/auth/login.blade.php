        ...
        <div class="col-md-6">
            <div class="mb-3">
                <div class="d-flex justify-content-center">
                    <svg viewBox="0 0 651 192" fill="none" xmlns="http://www.w3.org/2000/svg" width="200" >
                ...
                <h2 class="text-gray-500 pt-3 text-center font-weight-bold">
            ...
            <div class="card border-0">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="">
                                @if (Route::has('password.request'))
                                    <a class="btn btn-link text-indigo-600 border-0" href="{{ route('password.request') }}">
                        ...
                        <div class="pt-3">
                            <button type="submit" class="btn bg-indigo-600 btn-block">
                                Sign in
                            </button>
                        </div>
                    </form>
